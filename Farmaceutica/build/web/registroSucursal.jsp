...
<jsp:useBean id="provincia" class="Controllers.ProvinciaController" scope="page"></jsp:useBean>
<!DOCTYPE html>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content"class="p-md-2">
                ...
                <div class="container">
                    ...
                    <form action="RegistroSucursal" method="POST">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="txtDireccion" placeholder="Direccion" value="" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                            ...
                                            <c:forEach items= "${provincia.obtenerProvincias()}" var="p">
                                                <option value="${p.idProvincia}">${p.descripcion}</option>
                                                </c:forEach>
                                            </select>
                                    </div>
                                </div>
