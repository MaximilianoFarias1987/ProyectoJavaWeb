...
<jsp:useBean id="marca" class="Controllers.MarcasController" scope="page"></jsp:useBean>
<jsp:useBean id="categoria" class="Controllers.CategoriaController" scope="page"></jsp:useBean>
<jsp:useBean id="tipoSuministro" class="Controllers.TipoSuministroController" scope="page"></jsp:useBean>
    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content"class="p-md-2">
                ...
                <div class="container">
                    <h1> Registro Suministro</h1>
                    <form action="RegistroSuministro" method="POST">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="txtDescripcion" placeholder="Descripción" value="" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="txtPrecio" placeholder="Precio" value="" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">                                
                                            ...
                                            <c:forEach items= "${marca.obtenerMarcas()}" var="p">
                                                <option value="${p.idMarca}">${p.descripcion}</option>
                                                </c:forEach>
                                            </select>
                                    </div>
                                </div>
                                 <div class="col-md-6">
                                    <div class="form-group">                                
                                            ...
                                            <c:forEach items= "${categoria.obtenerCategorias()}" var="p">
                                                <option value="${p.idCategoria}">${p.descripcion}</option>
                                                </c:forEach>
                                            </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">                                
                                            <select name="cboTipoSuministro" class="form-control">
                                                <option disabled selected> Seleccione un Tipo de Suministro</option>
                                            <c:forEach items= "${tipoSuministro.obtenerTiposSuministros()}" var="p">
                                                <option value="${p.idTipoSuministro}">${p.descripcion}</option>
                                                </c:forEach>
                                            </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="txtStock" placeholder="Stock" value="" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">                                
